...
--------------
# Body from a file
python3 send_notifications.py --body-file reports/summary.md --title "Security Report"

# Body from a CLI argument
python3 send_notifications.py --body "All checks **passed** ✅"

# Body from stdin (pipe)
cat reports/summary.md | python3 send_notifications.py --title "Daily digest"

# Dry-run (print the payload without sending)
python3 send_notifications.py --body-file reports/summary.md --dry-run
"""
